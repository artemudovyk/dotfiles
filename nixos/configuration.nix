...

{
  ...
  services.xserver.xkb = {
    layout = "us,pl,ua";
    variant = "";
    # Switch layout with Alt+Shift (or choose "grp:win_space_toggle" for Super+Space)
  ...
  virtualisation.docker = {
    enable = true;
    # Automatically clean up unused containers/images weekly
    autoPrune = {
      enable = true;
      dates = "weekly";
    };
  ...
  # Enable fish on a system level to allow to use it as a default shell for my user
